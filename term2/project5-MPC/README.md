...
## Troubleshooting 
* Ipopt & CppAD installation:

Test environment: Ubuntu 14.04.4 LTS. 

Reference: https://github.com/casadi/casadi/wiki/InstallationLinux

1. svn co https://projects.coin-or.org/svn/Ipopt/stable/3.12 CoinIpopt
2. sudo ./install_ipopt.sh CoinIpopt/
3. install CppAD from source (https://www.coin-or.org/CppAD/Doc/install.htm)
